...
export const baseReportFiltersSchema = z
  .object({
  ...
  .refine(
    ...
    {
      message:
        "Para período customizado, datas inicial e final são obrigatórias",
    }
  );

// =================== SALES REPORT SCHEMA ===================

export const salesReportFiltersSchema = baseReportFiltersSchema
  .extend({
...
export const scheduledReportSchema = z.object({
  ...
  type: reportTypeSchema,
  filters: z.record(z.string(), z.any()), // Add key type
  schedule: z.object({
...
export type ProductReportFiltersInput = z.infer<
  typeof productReportFiltersSchema
>;
export type FinancialReportFiltersInput = z.infer<
  typeof financialReportFiltersSchema
>;
export type CustomerReportFiltersInput = z.infer<
  typeof customerReportFiltersSchema
>;
export type InventoryReportFiltersInput = z.infer<
...
export const calculateDateRange = (
  ...
  switch (period) {
    ...
    case "lastYear":
      ...
      const lastYearStart = new Date(`${lastYear}-01-01T00:00:00`);
