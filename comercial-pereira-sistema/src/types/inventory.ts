...
// Add to types/inventory.ts

// Minimal interface for stock operations that don't need full inventory data
export interface StockCheckData {
  quantity: number;
  minStock: number;
}

// Update utility functions to accept the minimal interface
export function isLowStock(inventory: InventoryBase | StockCheckData): boolean {
  return inventory.quantity <= inventory.minStock;
}

export function isOutOfStock(
  inventory: InventoryBase | StockCheckData
): boolean {
